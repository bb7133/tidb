...
func (s *Server) startHTTPServer() {
	...
	// router.PathPrefix("/invalid_ids/").Handle("/invalid_ids", invalidIdHandler{tikvHandlerTool})
	router.PathPrefix("/invalid_ids/").Handler(invalidIdHandler{tikvHandlerTool})
